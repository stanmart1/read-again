...
def create_receipt_pdf(order: Order) -> bytes:
    ...
    # Company Info
    elements.append(Paragraph("ReadAgain", header_style))
    elements.append(Paragraph("Digital Book Platform", normal_style))
    elements.append(Paragraph("support@readagain.com", normal_style))
...
def create_invoice_pdf(order: Order) -> bytes:
    ...
    elements.append(Paragraph("• For support, contact support@readagain.com", normal_style))

...
def initialize_default_settings(
    ...
    default_settings = [
        ...
        # Email Settings
        {"key": "email_from_name", "value": "ReadAgain", "data_type": "string", "category": "email", "description": "Email sender name"},
        {"key": "email_from_address", "value": "noreply@readagain.com", "data_type": "string", "category": "email", "description": "Email sender address"},
        {"key": "email_reply_to", "value": "support@readagain.com", "data_type": "string", "category": "email", "description": "Email reply-to address"},
        
        # Email Gateway API Keys
        {"key": "resend_api_key", "value": "", "data_type": "string", "category": "email", "description": "Resend API key"},
        {"key": "smtp_host", "value": "mail.readagain.com", "data_type": "string", "category": "email", "description": "SMTP server host"},
        {"key": "smtp_port", "value": "465", "data_type": "integer", "category": "email", "description": "SMTP server port"},
        {"key": "smtp_username", "value": "portal@readagain.com", "data_type": "string", "category": "email", "description": "SMTP username"},

    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {currentlyReading.slice(0, 3).map((book) => (
                <div key={book.id} className="flex items-center gap-4 p-3 rounded-lg hover:bg-muted transition-colors">
                  {/* Book Cover */}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{Math.round(book.progress || 0)}% complete</p>
                  </div>
                  {/* Continue Reading Button */}
                  <a
                    href={`/reading/${book.book_id}`}
                    className="px-4 py-2 bg-gradient-to-r from-primary to-primary text-white rounded-lg hover:shadow-md transition-all font-medium text-sm whitespace-nowrap"
                  >
                    Continue
                  </a>
                </div>
        ...
        >
          <a
            href="/books"
            className="bg-gradient-to-r from-primary to-primary text-white rounded-xl p-6 hover:shadow-lg transition-shadow"
          >
          ...
          <a
            ...
            className="bg-card rounded-xl p-6 hover:shadow-lg transition-shadow border-2 border-border"
          >
            <i className="ri-book-open-line text-3xl text-primary mb-2"></i>
            <h3 className="font-semibold text-foreground mb-1">My Library</h3>
          ...
          >
            ...
            <h3 className="font-semibold text-foreground mb-1">Order History</h3>
          ...
          <a
            ...
            className="bg-card rounded-xl p-6 hover:shadow-lg transition-shadow border-2 border-border"
          >
            <i className="ri-settings-line text-3xl text-green-600 dark:text-green-400 mb-2"></i>

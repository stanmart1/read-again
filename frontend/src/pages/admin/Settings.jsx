    ...
    <div className="space-y-3 sm:space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full px-2 sm:px-3 py-1.5 sm:py-2 text-sm border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring"
        />
      </div>
  ...
  const renderSecuritySettings = () => (
    <div className="space-y-6">
      ...
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 rounded-lg p-4">
        ...
        <div className="space-y-2">
          <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 dark:hover:bg-red-600">
            Clear All Cache
          </button>
          <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 dark:hover:bg-red-600 ml-2">
            Reset All Settings
          </button>
        </div>
      </div>

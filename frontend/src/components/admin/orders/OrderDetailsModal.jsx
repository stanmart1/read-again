        ...
        <div className="p-6 space-y-6">
                ...
                {displayOrder.items.map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                    <div className="flex-1">
                      <h4 className="font-medium text-foreground">{item.book?.title}</h4>
          ...
          <div className="bg-muted rounded-lg p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="border-t border-input pt-2 mt-2 flex justify-between font-semibold text-lg">
                <span>Total:</span>
          ...
          {displayOrder.notes && (
            <div className="bg-muted rounded-lg p-4">
              ...
              <p className="text-sm text-foreground">{displayOrder.notes}</p>
            </div>
          )}
      ...
      {showProofModal && displayOrder.payment_proof_url && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[60] p-4">
          <div className="bg-card rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-4 overflow-y-auto max-h-[calc(90vh-80px)] flex items-center justify-center bg-muted">
              <img

        ...
        <table className="w-full table-auto">
          <thead className="bg-muted border-b border-border sticky top-0">
            <tr>
              ...
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">User</th>
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">Email</th>
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">Role</th>
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">Status</th>
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">Joined</th>
              <th className="px-3 py-4 text-left text-sm font-semibold text-foreground whitespace-nowrap">Actions</th>
            </tr>
          </thead>
              ...
              <tr key={user.id} className="hover:bg-muted/50 transition-colors">
                ...
                <td className="px-3 py-3">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-primary-foreground font-semibold text-xs flex-shrink-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1">
                        ...
                        {user.school_name && (
                          <span className="inline-flex items-center px-1.5 py-0.5 text-xs font-semibold rounded bg-primary/20 text-primary" title="Student">
                ...
                <td className="px-3 py-3 text-xs text-muted-foreground truncate" title={user.email}>{user.email}</td>
                <td className="px-3 py-3">
                  {user.role ? (
                ...
                <td className="px-3 py-3">
                  <div className="flex gap-0.5">
                    <button
                      onClick={() => onView(user)}
                      className="p-1.5 text-primary hover:bg-primary/10 rounded transition-colors text-sm"
                      title="View"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded transition-colors text-sm"
                      title="Assign Role"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded transition-colors text-sm"
                      title="Analytics"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 text-teal-600 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/20 rounded transition-colors text-sm"
                      title="Assign Books"
                    >

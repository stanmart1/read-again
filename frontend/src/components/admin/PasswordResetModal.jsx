      ...
      >
        ...
        <div className="flex justify-end space-x-3 mt-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-primary to-primary text-white rounded-lg font-semibold hover:from-primary/90 hover:to-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
          >
